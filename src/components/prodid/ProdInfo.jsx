  ...
  return (
    <article className='prodinfo'>
        ...
        <div className='prodinfo_container'>
            <p className='prodinfo_price'><span>Price</span><span> $ {product?.price}.00</span></p>
        ...
        <button onClick={handleBuy} className='prodinfo_btnbuy'>Add to cart</button>
        </article>
  )
}
